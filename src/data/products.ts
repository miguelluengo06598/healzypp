...
// Nota: los datos de producto (antes mockeados aquí) ahora se leen de Supabase
// vía src/lib/db/products.ts. Este archivo solo conserva reviewsData, que es
// contenido de ejemplo independiente sin relación con la tabla `products`.
